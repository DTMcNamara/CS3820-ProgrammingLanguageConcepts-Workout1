...
-}
p9 :: Rational -> String
p9 s = show (numerator s) ++ " % " ++ show (denominator s)

-- print the rational number as numerator / denominator
p10 :: Rational -> String
p10 s = show (numerator s) ++ " / " ++ show (denominator s)
...
p16 :: [Int] -> Int
p16 a = (length a)-(length(elemIndices 0 a))
